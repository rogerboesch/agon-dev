...
static int s_vtext_cursor_x = 0;
static int s_vtext_cursor_y = 0;
...
void _vtext_moveby(int x, int y) {
    s_vtext_cursor_x += x*s_scale;
    s_vtext_cursor_y += y*s_scale;
}

void _vtext_lineby(int x, int y) {
    platform_draw_line(s_vtext_cursor_x, s_vtext_cursor_y, s_vtext_cursor_x+x*s_scale, s_vtext_cursor_y+y*s_scale);
